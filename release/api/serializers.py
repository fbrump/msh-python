...
class ReleaseSerializer(serializers.Serializer):
	...
	checkout_lunch = serializers.TimeField(format='%H:%M:%S', required=False, allow_null=True)
	checkin_lunch = serializers.TimeField(format='%H:%M:%S', required=False, allow_null=True)
